...
ALTER TABLE comprador AUTO_INCREMENT = 1;
...
ALTER TABLE arrives AUTO_INCREMENT = 1;
...
ALTER TABLE batch_statuses AUTO_INCREMENT = 1;
...
ALTER TABLE auctions_invites AUTO_INCREMENT = 1;
INSERT INTO auctions_invites (`auction_id`, `user_id`)
VALUES (4, 5), (4, 6);

ALTER TABLE private_sales AUTO_INCREMENT = 1;
...
ALTER TABLE users_ratings AUTO_INCREMENT = 1;
