...
DROP PROCEDURE IF EXISTS upgrade_database_20192301102223 $$

CREATE PROCEDURE upgrade_database_20192301102223()
...
CALL upgrade_database_20192301102223() $$

DROP PROCEDURE upgrade_database_20192301102223 $$
