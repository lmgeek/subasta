            ...
            <span class="hamburger-bottom-bread"></span>
                ...
                @if (Auth::check())                   
                        ...
                        <a href="#" rel="nofollow" tabindex="5" id="notiLink">
                            <img alt="image" width="20" height="20" src="{{ asset('/landing/img/header_notificaciones.png') }}" data-toggle="tooltip" data-placement="top" data-original-title="Notificaciones"/>
                        </a>
                        <a href="#" rel="nofollow" tabindex="5" aria-owns="modeless-48" aria-haspopup="true" popup-hidden="true" style="border-left: none">
                            <img alt="image" width="20" height="20" src="{{ asset('/landing/img/header_favoritos.png') }}" data-toggle="tooltip" data-placement="top" data-original-title="Favoritos"/><span></span>
                        </a>
