                    ...
                    <div class="tasks-list-container margin-top-35"  id="FeaturedAuctions">
                        ...
                        <div id="div_3" class="task-listing">
                            ...
                            <div class="task-listing-details">
                                ...
                                <div class="task-listing-description">
                                    <h3 class="task-listing-title"><a href="{{url('/home/subastas/'.$auction->id)}}">{{$auction->batch->product->name}} <?php $objtAuction->caliber($auction->batch->caliber)?></a> <div class="star-rating" data-rating="4.5"></div></h3>
                                    <ul class="task-icons">
