					...
					<div class="dashboard-box margin-top-0">
							...
							<div class="row">	
								...
								<div class="col-xl-3">
									<div class="submit-field">
                                        ...
                                        <select name="unidad" <?=($batchedit==0)?Constants::DISABLED:''?>  class="selectpicker with-border"  title="Seleccione..." onchange="changeSaleUnit()">
                                            <option disabled value='0'>Seleccione...</option>
						...
						<div class="content with-padding padding-bottom-10">
							<div class="row">
								...
								<div class="col-xl-4">
									<div class="submit-field">
                                        <h5>Cantidad de <div id="UnidadDeVenta">unidades</div> <i class="help-icon" data-tippy-placement="right" title="Cantidad disponible para esta subasta"></i></h5>
