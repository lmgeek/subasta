							...
							<div class="row">
								...
								<div class="col-xl-12">
									<div class="submit-field">
                                        ...
                                        <textarea cols="30" rows="5" class="with-border" data-translation="descripcion" minlength="120" maxlength="1000" name="descri"<?=($auctionedit==0)?Constants::DISABLED:'required'?>><?=$description?></textarea>
									</div>
								</div>
