            ...
            @if (Auth::check())
                ...
                <div class="header-widget">
                    ...
                    <div class="header-notifications user-menu">
                        <div class="header-notifications-trigger">
                            <a href="#"><div class="user-avatar"><img src="landing3/images/avatar/user-avatar-small-01.jpg" alt="jlopez"></div></a>
                        </div>
                        ...
                        <div class="header-notifications-dropdown">
                            ...
                            <div class="user-status">
                                ...
                                <div class="user-details">
                                    <div class="user-avatar status-online"><img src="landing3/images/avatar/user-avatar-small-01.jpg" alt=""></div>
                                    <div class="user-name">
