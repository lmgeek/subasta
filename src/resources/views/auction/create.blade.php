                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type='text' class="form-control" name="fechaInicio" id="datetimepickerStart" value="{{ old('fechaInicio') }}" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="text-center">
                                        <input type="text" value="{{ (is_null(old('amount'))?$batch->status->remainder:old('amount')) }}" data-max="{{ $batch->status->remainder }}" name="amount" class="dial m-r" data-fgColor="#1AB394" data-width="75" data-height="75"/>
