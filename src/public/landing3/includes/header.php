	...
	<div id="header">
		<div class="container">
			...
			<div class="left-side">
				...
				<!-- Logo -->
				<div id="logo">
					<a href="index.php"><img src="images/logo.png" alt="Subastas del mar"></a>
				</div>
			...
			<div class="right-side">
				...
				<div class="header-widget hide-on-mobile">
					...
					<div class="header-notifications">
						...
						<div class="header-notifications-link">
							<a href="dash-nueva-subasta.php" data-tippy-placement="left" title="Nueva Subasta" data-tippy-theme="dark"><i class="icon-feather-auction"></i></a>
						</div>
				...
				<div class="header-widget">
					...
					<div class="header-notifications user-menu">
						<div class="header-notifications-trigger">
							<a href="#"><div class="user-avatar"><img src="images/avatar/user-avatar-small-01.jpg" alt="jlopez"></div></a>
						</div>
						...
						<div class="header-notifications-dropdown">
							...
							<div class="user-status">
								...
								<div class="user-details">
									<div class="user-avatar status-online"><img src="images/avatar/user-avatar-small-01.jpg" alt="Julio López"></div>
									<div class="user-name">
										Julio L&oacute;pez <span class="blue">Netlabs</span>
									</div>
								</div>
