	...
	<div id="header">
		<div class="container">
			...
			<div class="left-side">
				...
				<!-- Logo -->
				<div id="logo">
					<a href="index.php"><img src="images/logo2.png" data-sticky-logo="images/logo.png" data-transparent-logo="images/logo2.png" alt="Subastas del Mar"></a>
				</div>
						...
						<div class="header-notifications-dropdown">
							...
							<div class="user-status">
								...
								<div class="user-details">
									<div class="user-avatar status-online"><img src="images/avatar/user-avatar-small-01.jpg" alt=""></div>
									<div class="user-name">
